...
export default function Home() {
  ...
  return (
    <div className='flex flex-col w-full h-full items-center justify-between bg-slate-900'>
      <Head>
        <title>Events</title>
      ...
      <main className='flex flex-col w-full items-center'>
        ...
        <div className='mt-10 w-2/3'>
            {eventData?.map((event: any, index: any) => (
              <div
                className='flex flex-col mb-3 cursor-pointer text-xl bg-slate-50 p-2 rounded'
                key={event.id}
